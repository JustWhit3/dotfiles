...
#Change HTCondor scheduler function
function condor_change_scheduler (){
    export _condor_SCHEDD_HOST="bigbird$1.cern.ch" #condor scheduler
    export _condor_CREDD_HOST="bigbird$1.cern.ch"  #condor scheduler
}
export -f condor_change_scheduler

#Check which HTCondor scheduler works:
